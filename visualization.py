...
def make_transit_map(geo_df: pd.DataFrame, df: pd.DataFrame, map_feature: str, layer_list: list):
    NTM_shapes, NTM_stops = queries.postgis_query()
    ...
    layer_list = [polygon_layer, shape_layer, stop_layer]
